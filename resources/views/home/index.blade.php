...
@section('content')
    ...
    {{-- CHARTS --}}
    <section class="w-full bg-white dark:bg-gray-800 md:pt-52 pt-32 pb-32 flex flex-col items-center" data-aos="fade-up">
        ...
        <div id="area-chart" class="md:w-1/2 w-full"></div>
    </section>
@endsection
