<div class="lg:w-96 w-5/6">
    ...
    <form class="w-full" action="" enctype="multipart/form-data">
        ...
        <div class="mb-5">
            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Sertifikasi</label>
        ...
        <div class="mb-2 mt-7">
          <label class="inline-flex items-center mb-5 cursor-pointer">
            <input type="checkbox" value="" name="open" class="sr-only peer">
