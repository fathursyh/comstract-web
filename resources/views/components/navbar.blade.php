<nav
    ...
    <div class="h-full w-full flex flex-wrap items-center justify-between p-4">
        ...
        <div class="md:flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse hidden">
          <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" onclick="changeURL('/login')" 
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-dropdown">
            <ul
                ...
                <li>
                    <a href="#"
                        class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria>
                        Beranda</a>
                </li>
                <li>
                    <a href="#"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Kegiatan</a>
                </li>
                <li>
                    <a href="#"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Tentang
                        Kami</a>
                </li>
            ...
            @endauth
                <li>
                    ...
                    <a href="#"
                        class="md:hidden flex items-center py-2 px-3 text-blue-500 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" aria>
                        Login Admin <img src="{{ URL::to('/') }}/assets/login.png" alt="" width="30px" class="ms-2">
                    </a>
                    @auth
